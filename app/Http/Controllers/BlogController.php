...
class BlogController extends Controller
{
    private function getMockPosts()
    {
        return [
            [
                'id' => 1,
                'title' => 'Bí Quyết Nấu Nước Dùng Mì Cay Chuẩn Vị Hàn',
                'slug' => 'bi-quyet-nau-nuoc-dung',
                'image' => 'assets/images/blog-05.jpg',
                'date' => '2023-12-28',
                'author' => 'Bếp Trưởng',
                'category' => 'Công Thức',
                'content' => 'Nước dùng là linh hồn của món mì cay Sincay...',
                'comments' => 12
            ],
            [
                'id' => 2,
                'title' => 'Review Mì Cay Cấp Độ 7 - Thử Thách Cực Đỉ',
            ...
            [
                ...
                'author' => 'Admin',
                'category' => 'Menu',
                'content' => 'Bò Mổ, Hải sản hay Xúc xích phô mai? Đâu là lựa chọn...',
                'comments' => 8
            ],
            [
                'id' => 4,
                'title' => 'Khuyến Mãi Mùa Đông: Đi 4 Tổng 1',
            ...
            [
                'id' => 6,
                'title' => 'Lẩu Uyển Ăn - Vị Ngon Gần Kết',
                'slug' => 'lau-uyen-uong',
            ...
            [
                ...
                'author' => 'Bếp Trưởng',
                'category' => 'Công Thức',
                'content' => 'Món ăn kèm không thể thiếu cho bữa tiệc mì cay thêm trọn vị...',
                'comments' => 42
            ],
            [
                'id' => 8,
                'title' => 'Mì Cay Cho Người Không Ăn Cay - Cấp Độ 0',
                'slug' => 'my-cay-cap-do-0',
                'image' => 'assets/images/blog-13.jpg',
                'date' => '2023-08-30',
                'author' => 'Admin',
                'category' => 'Menu',
                'content' => 'Bạn muốn thử thách cùng bạn bè nhưng không ăn được cay? Đừng lo...',
                'comments' => 9
            ],
            [
                'id' => 9,
            ...
            [
                'id' => 10,
                'title' => 'Rau Củ Tươi - Bổ Mắt Của Sức Khỏe Cân Bằng',
                'slug' => 'rau-cu-tuoi',
                'image' => 'assets/images/blog-15.jpg',
                'date' => '2023-07-25',
                'author' => 'Chuyên Gia',
                'category' => 'Sức Khỏe',
                'content' => 'Bổ sung chất xơ từ cải xanh, nấm kim châm giúp giải nhiệt...',
                'comments' => 2
            ]
        ];
    }
